...
6. **British & Australian English Spelling Conventions:** You must write exclusively using British / Australian spelling conventions (e.g. use 'tonne' instead of 'ton', 'colour' instead of 'color', 'optimisation' instead of 'optimization', 'programme' instead of 'program', 'stabilise' instead of 'stabilize', etc.). Never use American spelling conventions.
